...
console.log(user2.address);          // Cannot read properties of undefined (reading 'city')
console.log(user2?.address)          // undefined - we used optional chaining to get rid of errors
