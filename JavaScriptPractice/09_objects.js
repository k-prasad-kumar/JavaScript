...
console.log(user.name); // Prasad              // accesing object property using dot notaion

user.name = "Prasad Kumar"; // assiging new value to object property using dot notation

console.log(user.name); // Prasad Kumar        // accesing object property using dot notaion
...
// if we use dot notaion for storing variable as a key then it will store variable name as key not value
